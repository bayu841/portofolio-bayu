...
const projects = [
  ...
  { id:4, title: "SI RATU (Persuratan Terpadu)", desc: "Figma + Vue.js", image: "images/project/project5.webp" },
];
...
<template>
  <section
    ...
    id="projects"
    :class="[
      'text-white  min-h-screen md:px-16 py-[130px] px-4 transition-all duration-700',
