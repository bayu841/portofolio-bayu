...
>
    ...
    <div class="text-center mb-12">
      <h2 class="text-4xl font-bold text-gradient">
        Contact Me
      </h2>
    ...
    <!-- CONTAINER -->
      <div class="max-w-4xl mx-auto bg-gray-900/50 backdrop-blur-md border border-white/10 rounded-2xl p-5 sm:p-8 shadow-xl">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
        <!-- INFO -->
        <div>
          <h3 class="text-lg sm:text-xl font-semibold mb-4">Get in Touch</h3>
          <p class="text-gray-400 mb-6">
            Feel free to contact me for collaboration, freelance work, or just say hello 👋
          </p>
