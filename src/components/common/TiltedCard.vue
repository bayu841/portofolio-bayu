<template>
  ...
  >
    ...
    <Motion
      ...
      tag="figcaption"
      class="pointer-events-none absolute left-0 top-0 rounded-[4px] bg-gradient-to-r from-blue-500 to-purple-600 px-[10px] py-[4px] text-[14px] text-white opacity-0 z-[3] hidden sm:block"
      :animate="{
        x: xValue,
        y: yValue,
